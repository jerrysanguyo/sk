...
@section('content')
    ...
    <div
        class="w-full bg-white p-8 rounded-lg shadow-lg border border-gray-200 overflow-auto max-h-[85vh] min-h-[85vh]">
                ...
                @foreach ($data as $record)
                    <tr class="border border-gray-200 hover:bg-pink-50 transition-colors">
                        ...
                        @elseif ($resource === 'budget')
                            ...
                            <td class="py-2 px-4">
                                {{ $record->allocated ?? '' }} - Dated: {{ $record->date_allocated ?? '' }}
                            </td>
                            <td class="py-2 px-4">
                                {{ $record->spent ?? '' }} - Dated: {{ $record->date_spent ?? '' }}
                            </td>
